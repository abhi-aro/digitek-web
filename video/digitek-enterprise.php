...
<head>
  ...
  <style>
    .confirm-overlay {position: absolute;top: 0;left: 0;bottom: 0;right: 0;padding: 18% 0;background: rgba(255,255,255,0.98);}
    label.error{font-size: 10px;}
    #email_otp-error, #mobile_otp-error{position: fixed;}
    .confirm-q {text-align: center;}
    .confirm-q h2 {font-family: 'Roboto', sans-serif;padding-bottom: 25px;font-size: 25px;padding-top: 30px;font-weight: 500;}
    .confirm-q button.btn {margin: 0 25px;padding: 12px 30px;font-size: 16px;}
  </style>
<!-- ==== MACROS ==== -->
<!-- ==== login modal ==== -->
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="linkedin_btn">
            <a href="/social-auth/login/linkedin-oauth2/" id="linkedin_login"><img src="images/media/signupwithlinkedin.png" style="width: 100%" />
            </a>
          </div>
        ...
        <form action="" method="post" id="registerModalForm" class="needs-validation" novalidate>
          <div class="row signup_form">            
            <div class="container linkedin_btn">
              <a data-href="/social-auth/login/linkedin-oauth2/" id="linkedin_signup" class="" style="">
                <img src="images/media/signupwithlinkedin.png" class="linkedin-img" />
              </a>
            </div>
...
<body>
  ...
  <div class="main enterprise">      
    <div class="section-1">
            ...
            <div class="section-2-subsection">
              <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12 sec-1-b1">                  
                  ...
                  <p class="hero-heading-e pad-b-30">Simplified</p>
                  <p class="hero-sub-heading-p pad-b-30">Enable Competitive Procurement of Services.<br> Ensure Efficiency and Savings every time.</p>
                  <div class="row">                     
                    <div class="col-md-6 col-sm-6 col-xs-12">
      ...
      <div class="section-12 pad-top-30">
        <div class="container">
          <div class="row">
            <div class="col-xs-12">
              <div class="section-2-subsection">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="section-4-subsection">
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="panel panel-default gradient-col" style="min-height: 260px !important;">
                      <div class="section-card-heading">Online Marketing Agencies</div>
                      <hr class="hr1">
                      <div class="panel-body">
                        <div class="col-md-6 col-sm-6 col-xs-6 ">
