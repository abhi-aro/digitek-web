      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="linkedin_btn">
            <a href="/social-auth/login/linkedin-oauth2/" id="linkedin_login">
              <img src="images/media/signupwithlinkedin.png"style="width: 100%">
            </a>
          </div>
          ...
          <form method="post" id="loginModalForm" class="needs-validation" action="" name="loginModalForm">
            ...
            <div class="form-group">
              <input type="password" name="password" class="form-control" placeholder="Password" pattern=".{6,50}" title="Password must be minimum 6 and maximum 50 character"
              required="">
            ...
            <p class="forget-pass">
              <a class="pull-left hidden" data-toggle="modal" data-target="#signupModal">Create a new account</a> 
              <a data-toggle="modal" data-target="#forgotpasswordModal" class="pull-left">Forgot Password?</a>
            </p>
          </form><!-- login form end -->
        </div>
      </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form action="" method="post" id="registerModalForm" class="needs-validation" novalidate="" name="registerModalForm">
            <div class="row signup_form">
              <div class="container linkedin_btn">
                <a data-href="/social-auth/login/linkedin-oauth2/" id="linkedin_signup" class="" style=""><img src="images/media/signupwithlinkedin.png"
              ...
              <div class="col-lg-12">
                <div class="form-group focused">
                  <input type="email" name="email" id="email" value="" class="form-control form-control-lg" placeholder="Email* (Please provide official email ID)"
                  required=""> 
              ...
              <div class="col-lg-12">
                <div class="form-group focused" style="margin-bottom: 0px !important">
                  <input type="password" name="password" value="" class="form-control form-control-lg" minlength="6" maxlength="15" placeholder="Password* (must be atleast 6 characters)" id="password" required=""> <i class="fa fa-eye" id="show-hidePassword"></i>
                </div>
              </div>
          ...
          <form action="" method="post" id="emailotpModalForm" class="needs-validation" style="display:none;" novalidate="" name="emailotpModalForm">
            <div>
              ...
              <div class="row" style="margin-top: 8px">
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12" id="">
                  <button type="submit" id="submit_email_otp" class="btn button fill-btn padded font16" style="margin: 2px 0px 10px" value="">Verify
                  Email</button>
                </div>
              </div>
            </div>
        ...
        <div class="modal-body">
          ...
          <form action="" method="post" id="mobileSignupModalForm" class="needs-validation" novalidate="" name="mobileSignupModalForm">
            <div class="row" style="margin-bottom: -25px">
              <div class="col-lg-12">
                <div class="form-group focused">
                  <select id="source" name="source" style="width: -webkit-fill-available;height: 46px !important;border: 1px solid #ddd;;border-radius: 4px; color: black !important"
                  required="">
                ...
                <div class="col-lg-12">
                  <div class="form-group focused">
                    <label style="font-weight:400">
                      <input type="checkbox" name="terms" title="Please check the Terms & Policy." required=""> I agree to the <a href="/terms-of-use-client/" target="_blank">Terms
                    of Use</a> & <a href="/privacy-policy/" target="_blank">Privacy Policy</a>
                    </label>
                  </div>
                </div>
              ...
              <div id="vendor_detail" style="display:none;">
                ...
                "display:none">
                  <div class="col-lg-6">
                    <div class="form-group focused">
                      <input type="text" id="vendor_company" name="company_name" value="" class="form-control ui-autocomplete-input" autocomplete="off" placeholder=
                      "Company Name*">
                    </div>
                  </div>
                  <div class="col-lg-6">
                ...
                <div class="col-lg-12">
                  <div class="form-group focused">
                    <label style="font-weight:400"><input type="checkbox" name="terms" title="Please check the Terms & Policy."required=""> I agree to the <a href=
                    "/terms-of-use-service-provider/" target="_blank">Terms of Use</a> & <a href="/privacy-policy/" target="_blank">Privacy
                    Policy</a>
                    </label>
                  </div>
                </div>
        ...
        <div class="modal-body">
          ...
          <div class="row" style="margin-bottom: 20px" id='linkedin_usertype'>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <a href="#" data-id="client" class="btn btn-warning hero-buttons" style="font-size: 14px !important; width:185px !important; padding:6px !important">
        ...
        <div class="modal-body">
          ...
          <form action="" method="post" id="advocacyModalForm" class="needs-validation" novalidate="" name="advocacyModalForm">
            <div class="row">
              ...
              <div class="col-lg-12">
                <small style="color:red; text-align:center;" id="existingemailmsg"></small> <button type="submit" class="btn button fill-btn padded font16" id=
        ...
        <div class="modal-body">
          ...
          <form action="" method="post" id="subscribeModalForm" class="needs-validation" novalidate="" name="subscribeModalForm">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="form-group focused">
                  <input type="email" name="email" id="subs_email" value="" class="form-control form-control-lg" placeholder="Email Id(Please provide official email ID)"
                  required=""> 
        ...
        <div class="modal-body">
          ...
          <form action="" method="post" id="scheduleDemoModalForm" class="needs-validation" novalidate="" name="scheduleDemoModalForm">
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group focused">
                  <input type="text" name="company_name" class="form-control ui-autocomplete-input" autocomplete="off" placeholder="Company Name*" value="">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group focused">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top:30px">
                <div class="form-group text-left">
                  ...
                  <p class="privacy-policy">By submitting this form, you agree to the terms of our <a href="/privacy-policy/" target="_blank">Privacy
                  Policy.</a></p>
                  <p id="demo_msg"></p>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="form-group focused">
                  ...
                  <input type="file" name="resume" id="resume" value="" accept="application/pdf, application/vnd.openxmlformats-officedocument.wordprocessingml.document"
        ...
        <div class="modal-body">
          ...
          <form enctype="multipart/form-data" action="" method="post" id="contactAgencyModalForm" class="needs-validation" name="contactAgencyModalForm">
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="form-group focused">
                  <textarea class="form-control" id="details" name="details" rows="2" placeholder="Enter your message here..." style="height: auto"
                  required=""></textarea> 
