...
<body>
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="linkedin_btn">
            <a href="/social-auth/login/linkedin-oauth2/" id="linkedin_login"><img src="images/media/signupwithlinkedin.png" style="width: 100%"></a>
          </div>
          <div align="center" class="bottom_line_linkedin" style="margin-bottom: 0px !important">
            <h3 class="">OR</h3>
          </div>
          <small style="color:red" id="existingusermsg"></small>
          <form method="post" id="loginModalForm" class="needs-validation" action="" name="loginModalForm">
            <input type="hidden" name="csrfmiddlewaretoken" value="SDIVU1IJOt1PuTMKXLvGZ9RZUykpRDAyiJ3XWD6SLxV4vy0OIcCub4SRAK5OOIcQ">
            ...
            <p class="forget-pass">
              <a class="pull-left hidden" data-toggle="modal" data-target="#signupModal">Create a new account</a> <a data-toggle="modal" data-target="#forgotpasswordModal" class="pull-left">Forgot Password?</a>
            </p>
  ...
  <!-- ==== evisa modal ==== -->
  <div class="modal fade login-modal-design evisa-modal-box" data-backdrop="static" id="evisaModal" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          <div class="head-cross">
          ...
          <h2>Digitek eVisa Prototype</h2>
          <section class="slide-modal">
            <div class="slider-container-modal">
              <ul class="slider-wrapper" id="slider-modal">
                <li class="slide-current evisa-steps" style="height:2560px!important;">
                  <img src="images/media/1-Benefits_of_eVisas-scaled.jpg"/>
                  <div class="capa"></div>
                </li>
                <li class="" style="">
                  <img src="images/media/2-evisa-advantage.jpeg"/>
                  <div class="capa"></div>
                </li>
                <li class="evisa-steps" style="height:1300px!important;">
                  <img src="images/media/3-evisa-prototype.gif"/>
                  <div class="capa"></div>
                   <!--<video width="100%" height="100%" autoplay controls loop muted>
                    <source src="images/media/video-to-mp4.mp4" type="video/mp4">                    
                  </video>-->
                 </li>
                <li class="" style="">
                  <img src="images/media/evisa-step1.png"/>
                  <div class="capa"></div>
                </li>
                <li class="evisa-steps" style="">
                  <img src="images/media/evisa-step2.png"/>
                  <div class="capa"></div>
                </li>
                <li class="" style="">
                  <img src="images/media/evisa-step3.png"/>
                  <div class="capa"></div>
                </li>
                <li class="" style="height:300px!important;">
                  <img src="images/media/evisa-step4.jpg"/>
                  <div class="capa"></div>
                </li> 
                <li><video width="100%" height="100%" autoplay controls loop muted>
                    <source src="images/media/How to apply for visa on the JAPAN eVISA website (Before use) (payment in cash or payment exemption).mp4" type="video/mp4">
              ...
              <ul class="slider-controls-modal" id="slider-controls"></ul>
              <div class="tempo-bar" id="barra"></div>
            </div>
          </section>
          <!-- <img src="images/media/3-evisa-prototype.gif" class="full-width"> -->
        </div>
      </div>
    </div>
  </div>
  ...
  <script type="text/javascript">
    $(document).ready(function($){
      $("#slider-modal").QCslider({duration: 50000});
    });
  </script>
  <!-- ==== registration modal ==== -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form action="" method="post" id="registerModalForm" class="needs-validation" novalidate="" name="registerModalForm">
            <div class="row signup_form">
              <div class="container linkedin_btn">
                <a data-href="/social-auth/login/linkedin-oauth2/" id="linkedin_signup" class="" style=""><img src="images/media/signupwithlinkedin.png" class="linkedin-img" width="100%"></a>
              </div>
              <div align="center" class="bottom_line_linkedin" style="margin-bottom: 0px !important;">
                <h3 class="">OR</h3>
              </div>
              ...
              <div class="col-lg-12">
                <div class="form-group focused" style="margin-bottom: 0px !important">
                  <input type="password" name="password" value="" class="form-control form-control-lg" minlength="6" maxlength="15" placeholder=
                  "Password* (must be atleast 6 characters)" id="password" required=""> <i class="fa fa-eye" id="show-hidePassword"></i>
                </div>
              </div>
          ...
          novalidate="" name="emailotpModalForm">
            <div>
              ...
              <div class="form-group focused" style="margin-bottom: -28px">
                <input type="tel" maxlength="6" minlength="6" name="email_otp" id="email_otp" value="" class="form-control form-control-lg" placeholder="Enter Email OTP"> 
                <button class="btn btn_in" title="Resend Email OTP" id="resend_email_otp" style="background: #FFCD2D !important;" value=""></button>
              </div>
              <div class="row" style="margin-top: 8px">
                <p align="center" id="email-otp-error-msg" style="color:red; display:none;"></p>
                <div class="col-lg-6 col-sm-6 col-xs-6" id="">
                  <button title="Edit Details" id="edit_email_form" type="button" class="btn btn-link padded font16" value="">Edit Details</button>
                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h2>Digitek</h2>
          <form action="" method="post" id="mobileSignupModalForm" class="needs-validation" novalidate="" name="mobileSignupModalForm">
            <div class="row" style="margin-bottom: -25px">
              ...
              <div class="col-lg-12">
                <div class="form-group focused">
                  <input type="tel" name="phone_no" id="phone_no" value="" class="phone_no form-control form-control-lg" placeholder="Phone Number*"> 
              ...
              <div id="client_detail" style="display:none;">
                <div class="col-lg-12">
                  <div class="form-group focused">
                    <input type="text" id="client_company" name="company_name" value="" class="form-control ui-autocomplete-input" autocomplete="off" placeholder="Company Name*">
                    <input type="hidden" id="client" value="client"> <input type="hidden" name="website" value="">
                  </div>
                </div>
                ...
                <div class="col-lg-12">
                  <div class="form-group focused">
                    <label style="font-weight:400">
                      <input type="checkbox" name="terms" title="Please check the Terms & Policy." required=""> I agree to the <a href="/terms-of-use-client/" target="_blank">Terms of Use</a> & <a href="/privacy-policy/" target="_blank">Privacy Policy</a>
                    </label>
                  </div>
                </div>
              ...
              <div id="vendor_detail" style="display:none;">
                <div class="col-lg-12">
                  <div class="form-group focused">
                    <label style="font-weight:400"><input required="" type="radio" name="user_type" value="vendor"> I'm an Agency</label> 
                    <label style="font-weight:400"><input required="" type="radio" name="user_type" value="expert"> I'm an individual Expert</label>
                  </div>
                </div>
                <div class="col-md-12 vendor-qs" style="display:none">
                  <div class="col-lg-6">
                    <div class="form-group focused">
                      <input type="text" id="vendor_company" name="company_name" value="" class="form-control ui-autocomplete-input"
                      autocomplete="off" placeholder="Company Name*">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group focused">
                      <input type="text" name="website" value="" class="form-control form-control-lg website"placeholder="Company Website*">
                    </div>
                  </div>
                </div>
                <div class="col-lg-12 referral" style="display:none">
                  <div class="form-group focused">
                    <label style="font-weight:400">
                      <input type="checkbox" name="refer"> I have a referral code.</label>
                  </div>
                </div>
                ...
                <div class="col-lg-12">
                  <div class="form-group focused">
                    <label style="font-weight:400">
                      <input type="checkbox" name="terms" title="Please check the Terms & Policy." required=""> I agree to the <a href="/terms-of-use-service-provider/" target="_blank">Terms of Use</a> & <a href="/privacy-policy/" target="_blank">Privacy
                    Policy</a>
                  </label>
                  </div>
                </div>
          ...
          <form action="" method="post" id="mobileotpModalForm" style="display:none;" class="needs-validation" novalidate="" name="mobileotpModalForm">
            <div>
              <h4 style="color:green" align="center" id="sent_mobileotp_msg"></h4>
              <div class="form-group focused">
                <input type="tel" maxlength="6" minlength="6" name="mobile_otp" id="mobile_otp" value="" class="form-control form-control-lg" placeholder="Enter Mobile OTP"> 
                <button class="btn btn_in" id="resend_mobile_otp" style="background: #FFCD2D !important;margin-right:15px;" value=""></button>
                <div class="row" style="margin-top:-35px">
                  <p align="center" style="color:red; display:none; margin-top: 10px" id="mobile_otp_error_msg"></p>
                  <div class="col-lg-6 col-sm-6 col-xs-6" id="">
                    <button id="edit_mobile_form" type="button" class="btn btn-link padded font16" value="">Edit Details</button>
                  </div>
                  <div class="col-lg-12 col-sm-12 col-xs-12" id="">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form action="" method="post" id="advocacyModalForm" class="needs-validation" novalidate="" name="advocacyModalForm">
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group focused">
              ...
              <div class="col-lg-12">
                <div class="form-group focused">
                  <input type="tel" name="phone_no" value="" class="phone_no form-control form-control-lg" placeholder="Phone Number*">
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group focused">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form action="" method="post" id="forgotPasswordForm" class="needs-validation" novalidate="" name="forgotPasswordForm">
            ...
            </div><input type="submit" class="btn button fill-btn padded font16" value="Reset Password">
          </form>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form action="" method="post" id="resetPasswordForm" name="resetPasswordForm">
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group focused">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="text-center">
              <img src="images/media/logo.jpeg" style="margin-bottom:20px" width="150" alt="">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form action="" method="post" id="advo-mobileotpModalForm" class="needs-validation" novalidate="" name="advo-mobileotpModalForm">
            <div>
              <div class="form-group focused">
                <label for="mobile_otp" id="advo-mobiletext">Mobile Otp</label>
                <div class="row">
                  <div class="col-md-4">
                    <input type="tel" maxlength="6" minlength="6" name="advo-mobile_otp" id="advo-mobile_otp" value="" class="form-control form-control-lg">
                  </div>
                  <div class="col-md-8" style="margin-top:5px">
                    <button class="btn" id="advo-resend_mobile_otp" style="background: #FFCD2D !important;margin-right:15px;" value="">Resend</button> 
                    <button class="btn" id="advo-submit_mobile_otp" style="background: #FFCD2D !important;">Verify</button>
                  </div>
                </div>
              </div>
            </div>
          </form>
          <form action="" method="post" id="advo-emailotpModalForm" class="needs-validation" novalidate="" name="advo-emailotpModalForm">
            <div>
              <div class="form-group focused">
                <label for="email_otp" id="advo-emailtext">Email Otp</label>
                <div class="row">
                  <div class="col-md-4">
                    <input type="tel" maxlength="6" minlength="6" name="advo-email_otp" id="advo-email_otp" value="" class="form-control form-control-lg">
                  </div>
                  <div class="col-md-8" style="margin-top: 5px;">
                    <button class="btn" id="advo-resend_email_otp" style="background: #FFCD2D !important;margin-right:15px;" value="">Resend</button> 
                    <button class="btn" id="advo-submit_email_otp" style="background: #FFCD2D !important;">Verify</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="form-group text-left">
                <p id="otp-error-msg" style="color:red;display:none">Oops! Looks like our Engineers went to Sleep. Will wake them up and get
                this corrected.</p>
              </div>
            </div>
            <div class="col-lg-6">
              <button id="advo-edit_details" type="button" class="btn btn-link padded font16" value="">Edit Details</button>
            </div>
            <div class="col-lg-6">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form action="" method="post" id="subscribeModalForm" class="needs-validation" novalidate="" name="subscribeModalForm">
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group focused">
              ...
              <div class="col-lg-12">
                <div class="form-group focused">
                  <input type="email" name="email" id="subs_email" value="" class="form-control form-control-lg" placeholder=
                  "Email Id(Please provide official email ID)" required=""> <input type="hidden" value="1" formcheck="" id="subscriber_form" class="" name="subscriber_form">
                </div>
              </div>
              <p id="sub_msg"></p>
              <div class="col-lg-6">
                <button type="button" class="btn button fill-btn padded font16" data-dismiss="modal" value="">Not Interested</button>
              </div>
              <div class="col-lg-6">
                <button type="submit" id="submit-subscriber" class="btn button fill-btn padded font16" value="">Subscribe</button>
              </div>
            </div>
          </form>
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form action="" method="post" id="scheduleDemoModalForm" class="needs-validation" novalidate="" name="scheduleDemoModalForm">
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group focused">
                  <input type="text" name="company_name" class="form-control ui-autocomplete-input" autocomplete="off" placeholder="Company Name*"
                  value="">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top:30px">
                <div class="form-group text-left">
                  ...
                  <p class="privacy-policy">
                    By submitting this form, you agree to the terms of our <a href="/privacy-policy/" target="_blank">Privacy Policy.</a>
                  </p>
                  <p id="demo_msg"></p>
                </div>
              </div>
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="row">
            <div class="text-center">
              <img src="images/media/logo.jpeg" style="margin-bottom:20px" width="150" alt="">
              <div id="demomessage" style="margin: 0 0 20px;font-size: 16px;font-weight: 600;">
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <h2>Welcome to Digitek</h2>
          <h4>Apply now</h4>
          <form enctype="multipart/form-data" action="" method="post" id="jobApplicationModalForm" class="needs-validation" name="jobApplicationModalForm">
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group focused">
                  <input type="text" name="name" value="" class="form-control form-control-lg" placeholder="Name*" required="">
              ...
              <div class="col-lg-12">
                <div class="form-group focused">
                  <label for="resume" style="text-align:center;" id="">Upload Resume*</label> <input type="file" name="resume" id="resume" value="" accept="application/pdf, application/vnd.openxmlformats-officedocument.wordprocessingml.document" class="form-control form-control-lg">
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group focused">
              ...
              <div class="col-lg-12">
                <small style="color:red; text-align:center;" id="jobapplication_error_msg"></small> <input type="submit" class="btn button fill-btn padded font16" id="submit_btn_jobApplication" value="Apply">
              </div>
            </div>
          </form>
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form enctype="multipart/form-data" action="" method="post" id="contactAgencyModalForm" class="needs-validation" name="contactAgencyModalForm">
            <input type="hidden" name="csrfmiddlewaretoken" value="VOm4u126ikXUJjvaVplIMKgWNz55uujxlUH6wDqffoR9KYJeGQswYFhOtLQurzVP">
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group focused">
                  <input type="text" name="fullname" value="" class="form-control form-control-lg" placeholder="Name*" required="">
              ...
              <div class="col-lg-12">
                <div class="form-group focused">
                  <input type="text" name="company_name" class="form-control ui-autocomplete-input" placeholder="Company Name*" value="">
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group focused">
              ...
              <div class="col-lg-12">
                <small style="color:red; text-align:center;" id="contact_agency_error_msg"></small> <input type="submit" class="btn button fill-btn padded font16" id="submit_btn_contact_agency" value="Send">
              </div>
            </div>
          </form>
        </div>
  ...
  <div class="main index">
    ...
    <div class="section-1 bg-inherit">
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <div class="section-2-subsection">
              <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12 sec-1-b1">
                  ...
                  <div class="hero-info">
                    <h1 class="gradient-word">Services for SMBs.</h1>
                  </div><br>
                  <p class="hero-sub-heading">UAE's best agencies are here, to help you grow.</p>
                  <p class="hero-sub-heading"></p><br>
                  <p class="hero-sub-heading">Handpicked to suit your Industry and Budget.</p>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                      <a href="https://dashboard.digitekservice.com?user_type=1" class="btn btn-warning btn-primary">Register as an Agency</a><br>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 margin-video-top margin-video-top-p sec-1-b2">
                  <iframe width="100%" height="315px" src="https://www.youtube.com/embed/meho6KhOsqA" title="Digitek Process" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  <br>
                  <center>
  ...
  <style>
    ...
    header {position: unset !important;padding: 0px !important;}
    .discover_img {padding-top: 110px;}
  ...
  <style>
    .sec_cta {padding-top: 50px;}
    .sec_cta a {margin: 0px auto;}
    .sub_title {font-weight: 700;font-size: 36px;line-height: 50px;color: #333;margin-bottom: 20px;/*background: url(../static/digital-marketing-agencies/images/divider.png) no-repeat center bottom;*/ padding-bottom: 12px;}
    .small_title {text-align: center;color: #F2C94C;font-size: 20px;font-weight: 600;font-style: italic;}
    .step-class img {padding: 20px 20px 0px;}
    .step-class h3 {color: #0099FF;font-size: 18px;line-height: 26px;font-weight: 600;}
    .step-class p {padding: 0px 20px;color: #333;}
    .step-class {text-align: center;padding-top: 22px;}
    .cta_click {background: #F2C94C;color: #333;display: table; padding: 12px 20px;border-radius: 5px;font-size: 20px;font-weight: bold;}
    .cta_click:hover {background: #eb9316;color: #fff;text-decoration: none;}
    .cta_click i {font-size: 18px;font-weight: bold;margin-left: 10px;}
  </style>
  <section class="section" id="how-it-works">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="sub_title text-center" style="margin-bottom: 10px;">Digitek Service Procurement Model</h2>
      ...
      <div class="row step-class">
        <div class="col-md-3">
          <div class="box_step">
            <img src="images/media/step1.png" class="img-fluid">
            <h3>Create<br> a Digitek brief</h3>
            <p>Tell us a little about yourselfand your specific business challenge.</p>
          </div>
        </div>
        <div class="col-md-3">
          <div class="box_step">
            <img src="images/media/step2.png" class="img-fluid">
            <h3>Choose<br> the agency or expert</h3>
            <p>Our algorithm will curate and present best service providers suited to you.</p>
          </div>
        </div>
        <div class="col-md-3">
          <div class="box_step">
            <img src="images/media/step3.png" class="img-fluid">
            <h3>Partner with<br> the right service provider</h3>
            <p>Talk to service providers free of cost. Choose one. Get started!</p>
          </div>
        </div>
        <div class="col-md-3">
          <div class="box_step">
            <img src="images/media/step4.png" class="img-fluid">
            <h3>Get<br>work done</h3>
            <p>Share final scope of work and contract, Digitek will facilitate ontime delivery.</p>
          </div>
        </div>
      </div>
    </div>
