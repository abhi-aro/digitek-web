        ...
        <form action="" method="post" id="registerModalForm" class="needs-validation" novalidate>
          <div class="row signup_form">            
            <div class="container linkedin_btn">
              <a data-href="/social-auth/login/linkedin-oauth2/" id="linkedin_signup" class="" style=""><img src="images/media/signupwithlinkedin.png" class="linkedin-img" />
              </a>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="row">
          ...
          <img src="images/media/logo.jpeg" style="margin-bottom:20px" width="150" alt=""></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="row">
          <div class="text-center">
          <a href="#"><img src="images/media/logo.jpeg" style="margin-bottom:20px" width="150" alt=""></a>
