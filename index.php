      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="linkedin_btn">
            <a href="/social-auth/login/linkedin-oauth2/" id="linkedin_login"><img src="/static/images/signupwithlinkedin.43b7e1d2cd75.png"
            style="width: 100%"></a>
          </div>
  ...
  <div class="modal fade login-modal-design evisa-modal-box" data-backdrop="static" id="evisaModal" role="dialog">
    ...
    <div class="slider-container-modal">
      <ul class="slider-wrapper" id="slider-modal">
        <li class="slide-current" style="height:2560px!important;">
        ...
        <li class="" style="height:1300px!important;">
          ...
          <form action="" method="post" id="registerModalForm" class="needs-validation" novalidate="" name="registerModalForm">
            <div class="row signup_form">
              <div class="container linkedin_btn">
                <a data-href="/social-auth/login/linkedin-oauth2/" id="linkedin_signup" class="" style=""><img src="/static/images/signupwithlinkedin.43b7e1d2cd75.png" class="linkedin-img"></a>
              </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="text-center">
              <img src="/static/images/logo/logo_white.a718398d0f29.png" style="margin-bottom:20px" width="150" alt="">
