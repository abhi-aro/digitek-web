...
UAE's best agencies
                ...
                "col-md-6 col-sm-6 col-xs-12 margin-video-top margin-video-top-p sec-1-b2">
                  ...
                  ""><source src=
                  "video/Digitek-video.c68243863999.mp4"
    ...
    <!-- <div class="section-7">
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <p class="section-heading">Digitek in the press</p>
          </div>
          <div class="col-xs-12">
            <div id="team-slider" class="team-slider owl-carousel">
              <a href="https://Digitek.com/in-media/" target="_blank">
                <img src="images/media/businessline.jpg" alt="banner" class="slider-img">
              </a> 
              <a href="https://Digitek.com/in-media/" target="_blank">
                <img src="images/media/businesstelegraph.png" alt="banner" class="slider-img">
              </a> 
              <a href="https://Digitek.com/in-media/" target="_blank">
                <img src="images/media/ETrise.png" alt="banner" class="slider-img">
              </a> 
              <a href="https://Digitek.com/in-media/" target="_blank">
                <img src="images/media/livemint_rcjOLed.jpg" alt=
              "banner" class="slider-img">
              </a> 
              <a href="https://Digitek.com/in-media/" target="_blank">
                <img src="images/media/vccircle.png" alt="banner" class="slider-img">
              </a> 
              <a href="https://Digitek.com/in-media/" target="_blank">
                <img src="images/media/tech.png" alt="banner" class="slider-img">
              </a>
            </div>
          </div>
        </div>
            ...
            <ul class="slider">
              <li class="slide">
                <div class="slide-bg masked">
                  <img src="images/media/our-client-1.jpeg" alt="An Image" draggable="false">
                </div>
              ...
              <li class="slide">
                <div class="slide-bg masked">
                  <img src="images/media/our-client-3.png" alt="An Image" draggable="false">
                </div>
                <div class="slide-content">
                  <!-- <h2>Header 3</h2> -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          ...
          <p class="section-heading">Team</p>
        </div>
        <div class="col-xs-12">
